package case_StudyModule2.view;

import case_StudyModule2.model.Product;
import case_StudyModule2.model.Role;
import case_StudyModule2.model.User;
import case_StudyModule2.severies.IUserService;
import case_StudyModule2.severies.UserService;
import case_StudyModule2.utils.AppUtils;
import case_StudyModule2.utils.InstantUtils;
...
public class UserView {
    ...
    public String inputUsername() {
        ...
        do {
            if (!ValidateUtils.isUsernameValid(username = AppUtils.retryString("Username"))) {
                System.out.println("TÊN NGƯỜI DÙNG CỦA BẠN NHẬP KHÔNG ĐÚNG ĐỊNH DẠNG (>8 KÝ TỰ, KHÔNG BAO GỒM KÍ TỰ ĐẶC BIỆT,...)");
                System.out.print("NHẬP TÊN NGƯỜI DÙNG : ");
                continue;
            }
            if (userService.existsByUsername(username)) {
                System.out.println("TÊN NGƯỜI DÙNG NÀY ĐÃ TỒN TẠI, XIN NHẬP LẠI");
                System.out.print("NHẬP TÊN NGƯỜI DÙNG : ");
                continue;
            }
            break;
    ...
    private String inputEmail() {
        ...
        do {
            if (!ValidateUtils.isEmailValid(email = sc.nextLine())) {
                System.out.println("EMAIL CỦA BẠN KHÔNG ĐÚNG ĐỊNH DẠNG (xuantri@gmail.com)");
                System.out.print("NHẬP EMAIL : ");
                continue;
            }
    ...
    private String inputPassword() {
        ...
        while (!ValidateUtils.isPasswordValid(password = sc.nextLine())) {
            System.out.println("MẬT KHẨU PHẢI > 8 KÍ TỰ VÀ SỐ");
            System.out.print("NHẬP MẬT KHẨU : ");
        }
        return password;
    }
